...
public class ThirdMax {
    ...
    public int thirdMax(int[] nums) {
        ...
        Integer max3 = null;
        for (Integer n : nums) {
            if (n.equals(max1) || n.equals(max2) || n.equals(max3)) //don't forget to ignore duplicates
                continue;

            if (max1 == null || n > max1) { //don't forget to check null values
                max3 = max2; //NOTE:The giving value order here can not be changed!!!!!!
                max2 = max1;
                max1 = n;
        ...
        return max3 == null ? max1 : max3; //check null
    }
...
//                    set.remove(num);
    ...
    public static void main(String[] args) {
        ...
        tm.thirdMax2(new int[]{2, 2, 3, 1, 4, 6, 1});
    }
}
